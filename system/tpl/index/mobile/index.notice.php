...
function load_html(result){
	...
	if(lists.length>0){
		for (i = 0, ii = lists.length; i < ii; i++) {
			...
			tmp_html=tmp_html + '<a href="?m=index&c=news&id=' + tmp_data.id + '" class="notice_list">';
...
function load_url(){
	var url='?m=index&c=notice_list&page=' + page + '&limit=' + limit;
...
<div class="jui_top_bar">
     ...
     <div class="jui_top_middle">平臺公告</div>
</div>
