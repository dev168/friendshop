...
<!-- 輪播圖end -->
<!-- 分類 -->
<div class="jui_flex jui_flex_wrap jui_pad_t5 jui_pad_b5">
  <?php
        foreach($cates as $c){
        ?>
  <a href="?m=index&c=lists&id=<?php echo $c['id'];?>" class="jui_grid_list jui_grid_w25"> <img class="school_icon" src="<?php echo $c['c_img'];?>">
  <P><?php echo $c['c_name'];?></P>
  </a>
  <?php
        }
        ?>
...
<!-- 分類end -->
<div class="jui_h12 jui_bg_grey"></div>
<!-- 主體 -->
