...
<div class="jui_top_bar jui_top_fixed">
    ...
    <div class="jui_top_middle">發布商品</div>
</div>
<!-- 頭部end -->
...
<form action="">
    <div class="jui_bg_fff">
        <div class="jui_public_list">
            ...
            <input class="jui_flex1" name="g_title" type="text" value="" placeholder="請輸入商品名稱">
        </div>
        <div class="jui_public_list jui_flex_row_center">
            <p class="jui_flex_no jui_pad_r8"></p>
            <input class="jui_flex1" name="g_price" type="number" value="" placeholder="請輸入商品價格 （請輸入數字）">
        </div>
    </div>
    ...
    <div class="jui_bg_fff">
        ...
        <div class="addpro_upimg">
            ...
            <input type="file" onChange="previewImage(this)" style="display:none;" id="previewImg" name="g_pic"/>
        </div>
    </div>
    <div class="jui_h12"></div>
    <div class="jui_bg_fff">
        ...
        <!-- 富文本 -->
        <div class="edit_con">
            <textarea id="txt-content" name="g_content" data-autosave="editor-content" autofocus required style="height: 50rem;"></textarea>
        </div>
    </div>
    <!-- 富文本end -->
