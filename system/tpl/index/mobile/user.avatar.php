...
<div class="jui_top_bar">
     ...
     <div class="jui_top_middle">上傳頭像</div>
...
<div class="container">
    <div class="img-container">
        <img id="image" src="<?php echo empty($user['m_avatar'])?'/public/image/tx.jpg':$user['m_avatar'];?>">
    </div>
</div>
<div class="footer">
    <div class="toolbar">
        ...
        <span id="up-btn-submit">保存頭像</span>
    </div>
</div>
</body>
      ...
      document.getElementById('up-btn-submit').addEventListener('click', function () {
        ...
        if (cropper) {
          ...
          canvas.toBlob(function (blob) {
				...
				$.ajax('?m=user&c=avatar', {method: 'POST',data: formData,processData: false,contentType: false,
